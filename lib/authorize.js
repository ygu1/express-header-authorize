...
function () {
  ...
  _createClass(Authorize, [{
    ...
    key: "authorizeWithHeader",
    value: function () {
      var _authorizeWithHeader = _asyncToGenerator(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee3(header) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                throw new Error('Please provide non empty header!');
              ...
              case 3:
                ...
                _context3.next = 7;
                return this.authorizeWithAccesstoken(header.accesstoken);
              ...
              case 16:
                ...
                _context3.next = 19;
                return this.authorizeWithAccesstoken(header.access_token);
              ...
              case 22:
                ...
                _context3.next = 27;
                return this.authorizeWithAccesstoken(accesstoken);
              ...
              case 30:
                _context3.next = 32;
                return this.authorizeWithBasicAuth(header.authorization);
      ...
      function authorizeWithHeader(_x3) {
        return _authorizeWithHeader.apply(this, arguments);
      }

      return authorizeWithHeader;
    }()
  }]);
